...
توفر شركة DeepSeek منصة ويب وتطبيقاً رسمياً للهواتف الذكية (Android وiOS) يتيح استخدام النموذج مجاناً بالكامل.
* قم بزيارة الموقع الرسمي: [chat.deepseek.com](https://chat.deepseek.com)
* قم بإنشاء حساب مجاني باستخدام بريدك الإلكتروني.
* ابدأ الدردشة مباشرة، وتأكد من تفعيل خيار **"DeepSeek-R1"** أسفل صندوق المحادثة لتفعيل محرك الاستدلال.

### 2. تشغيل النموذج محلياً (بدون إنترنت مجاناً)
بما أن النموذج مفتوح المصدر، يمكنك تحميل نسخة مخففة منه وتشغيلها بالكامل على حاسوبك الشخصي باستخدام أداة **Ollama**.
* قم بتحميل وتثبيت برنامج Ollama من موقعه الرسمي.
* افتح واجهة الأوامر (Terminal / Command Prompt) واكتب الأمر التالي لتحميل نسخة 8 مليار بارامتر المناسبة للحواسيب المتوسطة:
  ```bash
  ollama run deepseek-r1:8b
  ```
* سيتم تحميل النموذج ويمكنك التفاعل معه مباشرة من شاشتك وبسرية تامة لبياناتك.
